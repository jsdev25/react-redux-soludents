  ...
  render() {
    return (
      <div className="main-login main-login--fullscreen">
        ...
        <div className="main-login__footer text-center" style={{backgroundColor:'#eee'}}>
          <span>So you can't get in to your account? Did you </span>
          <span style={{color:'#55acef'}}> forget your password?</span>
        </div>
      </div>
    )
  }
