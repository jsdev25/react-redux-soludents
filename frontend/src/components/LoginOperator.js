...
import { LoginOperatorfunc } from '../actions/authentication';
...
LoginOperator.propTypes = {
    LoginOperatorfunc: PropTypes.func.isRequired,
...
export  default connect(mapStateToProps, { LoginOperatorfunc })(LoginOperator)